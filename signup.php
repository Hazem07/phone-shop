...
require("includes/header.php");
        ...
        <div class="container-fluid decor_bg" id="content">
            <div class="col-lg-4 col-md-6">
                <img style="width: 27em;margin-top: -2em;margin-left: 9em;" src="img/login.png">
            </div>
            <div class="row">
                <div class="container">
                    <div class="col-lg-4 col-lg-offset-3 col-md-6">
                        ...
                        <form  action="signup_script.php" method="POST">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control"  placeholder="Contact" maxlength="8" size="8" name="contact" required = "true"><?php if(isset($_GET['m2'])) echo $_GET['m2']; ?>
                            </div>
                            <div class="form-group">
